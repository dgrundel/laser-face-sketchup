...
/***/ "./node_modules/alfador/src/Epsilon.js":
/*!*********************************************!*\
  !*** ./node_modules/alfador/src/Epsilon.js ***!
  \*********************************************/
...
/***/ "./node_modules/alfador/src/Mat33.js":
/*!*******************************************!*\
  !*** ./node_modules/alfador/src/Mat33.js ***!
  \*******************************************/
/*! no static exports found */
...
(function() {
    ...
    var Vec3 = __webpack_require__(/*! ./Vec3 */ "./node_modules/alfador/src/Vec3.js");
    var EPSILON = __webpack_require__(/*! ./Epsilon */ "./node_modules/alfador/src/Epsilon.js");
...
/***/ "./node_modules/alfador/src/Mat44.js":
/*!*******************************************!*\
  !*** ./node_modules/alfador/src/Mat44.js ***!
  \*******************************************/
/*! no static exports found */
...
(function() {
    ...
    var Vec3 = __webpack_require__(/*! ./Vec3 */ "./node_modules/alfador/src/Vec3.js");
    var Vec4 = __webpack_require__(/*! ./Vec4 */ "./node_modules/alfador/src/Vec4.js");
    var Mat33 = __webpack_require__(/*! ./Mat33 */ "./node_modules/alfador/src/Mat33.js");
    var EPSILON = __webpack_require__(/*! ./Epsilon */ "./node_modules/alfador/src/Epsilon.js");
...
/***/ "./node_modules/alfador/src/Quaternion.js":
/*!************************************************!*\
  !*** ./node_modules/alfador/src/Quaternion.js ***!
  \************************************************/
/*! no static exports found */
...
(function() {
    ...
    var Vec3 = __webpack_require__(/*! ./Vec3 */ "./node_modules/alfador/src/Vec3.js");
    var Mat33 = __webpack_require__(/*! ./Mat33 */ "./node_modules/alfador/src/Mat33.js");
    var Mat44 = __webpack_require__(/*! ./Mat44 */ "./node_modules/alfador/src/Mat44.js");
...
/***/ "./node_modules/alfador/src/Transform.js":
/*!***********************************************!*\
  !*** ./node_modules/alfador/src/Transform.js ***!
  \***********************************************/
/*! no static exports found */
...
(function() {
    ...
    var Vec3 = __webpack_require__(/*! ./Vec3 */ "./node_modules/alfador/src/Vec3.js");
    var Mat44 = __webpack_require__(/*! ./Mat44 */ "./node_modules/alfador/src/Mat44.js");
    var Quaternion = __webpack_require__(/*! ./Quaternion */ "./node_modules/alfador/src/Quaternion.js");
...
/***/ "./node_modules/alfador/src/Triangle.js":
/*!**********************************************!*\
  !*** ./node_modules/alfador/src/Triangle.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./node_modules/alfador/src/Vec2.js":
/*!******************************************!*\
  !*** ./node_modules/alfador/src/Vec2.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./node_modules/alfador/src/Vec3.js":
/*!******************************************!*\
  !*** ./node_modules/alfador/src/Vec3.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./node_modules/alfador/src/Vec4.js":
/*!******************************************!*\
  !*** ./node_modules/alfador/src/Vec4.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./node_modules/alfador/src/exports.js":
/*!*********************************************!*\
  !*** ./node_modules/alfador/src/exports.js ***!
  \*********************************************/
/*! no static exports found */
...
(function () {
    ...
    module.exports = {
        Mat33: __webpack_require__(/*! ./Mat33 */ "./node_modules/alfador/src/Mat33.js"),
        Mat44: __webpack_require__(/*! ./Mat44 */ "./node_modules/alfador/src/Mat44.js"),
        Vec2: __webpack_require__(/*! ./Vec2 */ "./node_modules/alfador/src/Vec2.js"),
        Vec3: __webpack_require__(/*! ./Vec3 */ "./node_modules/alfador/src/Vec3.js"),
        Vec4: __webpack_require__(/*! ./Vec4 */ "./node_modules/alfador/src/Vec4.js"),
        Quaternion: __webpack_require__(/*! ./Quaternion */ "./node_modules/alfador/src/Quaternion.js"),
        Transform: __webpack_require__(/*! ./Transform */ "./node_modules/alfador/src/Transform.js"),
        Triangle: __webpack_require__(/*! ./Triangle */ "./node_modules/alfador/src/Triangle.js")
    };
...
var alfador = __webpack_require__(/*! alfador */ "./node_modules/alfador/src/exports.js");
var Vec3 = alfador.Vec3;
var Quaternion = alfador.Quaternion;

var Z_NORMAL = new Vec3(0, 0, -1);
/**
 * Logic from:
 ...
 * @param next - last
 */
var computeAngleBetweenPoints = function (prev, curr, next) {
    // In pseudo-code, the vector BA (call it v1) is:
    // v1 = {A.x - B.x, A.y - B.y, A.z - B.z}
    // Similarly the vector BC (call it v2) is:
    // v2 = {C.x - B.x, C.y - B.y, C.z - B.z}
    var v1 = prev.sub(curr);
    var v2 = next.sub(curr);
    ...
    var res = v1norm.dot(v2norm);
    // And finally, recover the angle:
    // angle = acos(res)
    var angleInRadians = Math.acos(res);
...
var getDistance = function (a, b) {
    var aSq = Math.pow(Math.abs(a.x - b.x), 2);
    var bSq = Math.pow(Math.abs(a.y - b.y), 2);
    var cSq = aSq + bSq;
...
function createPolygon(loop, svg) {
    var pointStr = loop.map(function (p) { return [p.x, p.y].join(','); }).join(' ');
 ...
 * @param otherLoops
 */
var makeSvg = function (outerLoop, otherLoops) {
    var widthHeight = outerLoop.reduce(function (max, p) {
        return [
            Math.max(max[0], p.x),
            Math.max(max[1], p.y)
        ];
    }, [0, 0]);
    var viewBoxStr = '0 0 ' + widthHeight.join(' ');
    var svg = document.createElement('svg');
    svg.setAttribute('viewBox', viewBoxStr);
    // create polygon element
    createPolygon(outerLoop, svg);
    otherLoops.forEach(function (loop) { return createPolygon(loop, svg); });
...
var calcAndDisplayAngles = function (polygon) {
    console.log("polygon:", polygon);
    var sum = 0;
    for (var i = 0, len = polygon.length, last = len - 1; i < polygon.length; i++) {
        var curr = polygon[i];
        var prev = i === 0 ? polygon[last] : polygon[i - 1];
        var next = i === last ? polygon[0] : polygon[i + 1];
        var angle = computeAngleBetweenPoints(prev, curr, next);
        console.log("angle at point " + i + ": " + angle);
        sum += angle;
    }
    console.log("sum of angles: " + sum);
};
var createOffsetter = function (outerLoop) {
    var first = new Vec3(outerLoop[0]);
    var minX = 0;
    var minY = 0;
    outerLoop.forEach(function (vec) {
        var v = vec.sub(first);
...
// });
var w = window;
var sketchup = w.sketchup;
// setTimeout(sketchup.getJson, 1500);
sketchup.getJson();
w.LaserFace = {
    setJson: function (faces) {
        faces.forEach(function (f) {
            var rotation = Quaternion.rotationFromTo(f.normal, Z_NORMAL);
            var outerLoop = f.outer_loop.map(function (v) { return rotation.rotate(v); });
            var offsetter = createOffsetter(outerLoop);
            var outerLoop2d = outerLoop.map(offsetter);
            var otherLoops = f.other_loops.map(function (loop) { return loop.map(function (v) { return rotation.rotate(v); }).map(offsetter); });
            var elem = makeSvg(outerLoop2d, otherLoops);
            thumbs.appendChild(elem);
        });
